      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3">
            <button type="button" onClick={() => setDepositTarget(null)} className="rounded-xl px-4 py-2.5 text-sm font-medium text-navy/70 hover:bg-navy/5 dark:text-gray-400 dark:hover:bg-white/5">
              취소
            </button>
            <button
              type="button"
