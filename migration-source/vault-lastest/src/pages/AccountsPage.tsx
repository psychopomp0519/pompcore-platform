        ...
        <div className="flex gap-2">
          {accounts.length >= 2 && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border border-vault-color/30 px-4 py-2 text-sm font-medium text-vault-color transition-colors hover:bg-vault-color/10"
            >
